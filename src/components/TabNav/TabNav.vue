<template>
	<div class="TabNav px-3 pt-2 border-t border-gray-700 border-opacity-50 pb-safe-area-bottom bg-gray-900">
...
<script setup>
	...
	const tabNavItems = [
		...
		{ name: userName.value, route: 'App-Account', icon: IconCollectionMove, },
	]
